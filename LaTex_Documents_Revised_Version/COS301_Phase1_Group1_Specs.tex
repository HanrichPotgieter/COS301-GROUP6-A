...
\begin{center}
  \begin{tabular}{| p{3cm} | p{4cm} | p{4cm} | p{4cm} |}
    ...
    Validation & Post is palgiarised and/or does not follow netiquette & Post is valid against rules  & This module will validate the any post send to it in terms of plagiarism check and also to check to see if the post follows certain netiquette rules. The post will also make sure of valid user acces by using the Usermanagement module. This system will also help the Report system to generate certain reports regarding the above validation.\\ \hline
