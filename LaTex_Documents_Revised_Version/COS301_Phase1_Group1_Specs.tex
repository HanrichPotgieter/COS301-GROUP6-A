...
\section{Functional requirements}
	\begin{center}
  	 	\includegraphics[width=1\textwidth] {../Lelethu/BuzzSystem.jpg}\\[0.4cm]    
	\end{center}
...
\begin{center}
  \begin{longtable}{| p{3cm} | p{4cm} | p{4cm} | p{4cm} |}
    ...
    Validation & Post is plagiarism and/or does not follow netiquette & Post is valid against rules  & This module expresses how the Buzz system will validate a post and/or thread before publishing it. It checks for plagiarism and netiquette errors as well as if the user has valid privileges. \\ \hline
...
\begin{itemize}
	...
	\begin{flushleft}
 A Buzz Space is a integral component of the Buzz System which facilitates the management of threads added by its users. Buzz Spaces may be created for each active module in the Computer Science Department in order to promote intuitive communication between the Computer Science staff and its students.	
		\end{flushleft}
		\begin{center}
  	 	\includegraphics[width=1\textwidth] {../Lelethu/BuzzSpace.jpg}\\[0.4cm]    
		\end{center}
\newpage
\item \textbf{Validation}
		\begin{flushleft}
This module will be used to make sure that post follow certain rules and help generate certain reports regarding these rules.
		\end{flushleft}
		\begin{center}
...
\begin{itemize}
	\item CreateBuzzSpace
		\begin{center}
  	 	\includegraphics[width=1\textwidth] {../Lelethu/createBuzzSpace.jpg}\\[0.4cm]    
		\end{center}
	\item Validation
		\begin{center}
