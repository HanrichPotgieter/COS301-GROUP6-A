...
\begin{center}
  \begin{tabular}{ p{3cm} | p{3cm} | p{3cm} | p{4cm} }
    ...
    Automatic update of the user status & User is logged in\n , Nothing is posted and old status remains. & User posted and status updated, \n or User logged out and not updated status old status remains & User logs in and updates his or her status and status is updated \\ \hline
    \hline
  \end{tabular}
\end{center}
...
\item \textbf{Validation}. This module will be used to make sure that post follow certain rules and help generate certain reports regarding these rules.
		\begin{center}
  	 	\includegraphics[width=1\textwidth] {../Chris/Validation2.jpg}\\[0.4cm]    
		\end{center}
\newpage
